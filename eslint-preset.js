module.exports = {
    ...
    plugins: ['react'], // will try react-refresh
    parserOptions: {
    ...
    rules: {
        ...
        'no-trailing-spaces': ['error', { skipBlankLines: false }], // disallow trailing whitespace at the end of lines, allow in blank lines
    ...
    globals: {
        ...
        define: true, // allow define in global
        expect: true, // expect for test
        it: true, // it for test
        require: true, // allow require in global
    },
    overrides: [
        {
            files: ['*.ts', '*.tsx'],
