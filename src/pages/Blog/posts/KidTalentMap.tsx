...
import { Content } from '@/utils/generateContent';

export const KidTalentMap: Post = {
    ...
    details: [
        ...
        },
        {
            type: Content.p,
            content: [
                `${coach.name} từ khi biết đến bộ số của con mình, là một đứa trẻ (đang 2 tuổi rưỡi vào thời điểm ${coach.lastName} viết bài này) ngày sinh 6, đường đời 4, linh hồn 7 ${coach.lastName} đã biết cách giao tiếp và trò chuyện với con, biết cách điều hướng trẻ làm những việc tốt mà không bị trẻ từ chối. Con có ngày sinh 6 là người sống rất tình cảm và thích được gần gũi với bố mẹ, người thân, thích được nói lời yêu thương và quan tâm, đặc biệt thể hiện là người rất thích âm nhạc và nhảy múa.`,
                `Và khi mở bản đồ ra ${coach.lastName} mới biết tại sao trước khi ăn cái gì đó con hay ngửi ngửi trước, thử thử trước rồi mới bắt đầu ăn đều, bởi bản tính cẩn thận của linh hồn 7 và đường đời 4; con cũng rất thích học hỏi và khám phá, thường xuyên đặt những câu hỏi để được thỏa mãn sự tò mò của mình. Và còn nhiều hơn nữa những biểu hiện khác mà ${coach.lastName} đã được tấm bản đồ nhắc nhở để định hướng cho con.`,
                `Nếu không mở bản đồ thì chắc chắn ${coach.lastName} sẽ thấy rất khó chịu bởi nhiều khi con rất bướng, nói không nghe, nhưng từ khi biết con không thích áp đặt, tôi luôn giao tiếp với con bằng cách cho con các sự lựa chọn, bằng cách đưa ra những lời đề nghị, đàm phán thỏa hiệp để con tự mình quyết định. Từ đó mà con luôn nghe lời. Điển hình như việc mở điện thoại xem hoạt hình hay xem hát, tôi luôn thỏa thuận trước xem mấy phút, xem mấy video, xem hết là tắt nhé, luôn hỏi ý kiến con và trao đổi với con trước, và khi xem xong video hoặc xem hết bao nhiêu phút là con tự tắt. Rất nhẹ nhàng, chứ nếu là lúc xưa trước khi biết bộ số của on, ${coach.lastName} sẽ giật phăng cái điện thoại hoặc quát mắng con rồi.`,
                `${coach.lastName} hi vọng rằng Kid Talent Map sẽ được lan tỏa đến rộng rãi các bậc phụ huynh đang có con đi học ngày càng mạnh mẽ hơn nữa.`
            ]
        },
        {
            type: Content.s,
